...
Producer.delete_all
bobbee = Producer.create! name: 'Bobbees Bottling', contact_name: 'John Aschenbrenner', address: '42 Golden Leaf Drive, Louisburg, NC 27549', phone: '919-496-4286', email: 'service@bobbeesbottling.com'
...
Supplier.create! name: 'Bobbees Bottling', contact_name: 'John Aschenbrenner', address: '42 Golden Leaf Drive, Louisburg, NC 27549', phone: '919-496-4286', email: 'service@bobbeesbottling.com'
...
ProductionRun.create!(producer_id: bobbee.id, invoice_number: "201502295", product_id: zukti_10oz.id, mfgd_date: "2015-11-20", expiry_date: "2017-05-20", lot_name: "L3241115", mfgd_amount: 805)
ProductionRun.create!(producer_id: bobbee.id, invoice_number: "201502295", product_id: piaz_716oz.id, mfgd_date: "2015-11-20", expiry_date: "2017-05-20", lot_name: "L3241115", mfgd_amount: 131)
...
ProductionRun.create!(producer_id: bobbee.id, invoice_number: "20160560", product_id: piaz_half.id, mfgd_date: "2016-03-30", expiry_date: "2017-09-30", lot_name: "L0890316", mfgd_amount: 6)
ProductionRun.create!(producer_id: bobbee.id, invoice_number: "20160813", product_id: piaz_black_lid.id, mfgd_date: "2016-05-05", expiry_date: "2017-11-05", lot_name: "L1260516", mfgd_amount: 434)
ProductionRun.create!(producer_id: bobbee.id, invoice_number: "20160812", product_id: zukti_stout.id, mfgd_date: "2016-05-05", expiry_date: "2017-11-05", lot_name: "L1260516", mfgd_amount: 954)
ProductionRun.create!(producer_id: bobbee.id, invoice_number: "20161033", product_id: piaz_716oz.id, mfgd_date: "2016-06-01", expiry_date: "2017-12-01", lot_name: "L1520516", mfgd_amount: 210)
ProductionRun.create!(producer_id: bobbee.id, invoice_number: "20161033", product_id: piaz_baby.id, mfgd_date: "2016-06-01", expiry_date: "2017-12-01", lot_name: "L1520516", mfgd_amount: 410)
ProductionRun.create!(producer_id: bobbee.id, invoice_number: "20161033", product_id: zukti_plastic.id, mfgd_date: "2016-06-01", expiry_date: "2017-12-01", lot_name: "L1480516", mfgd_amount: 214)
ProductionRun.create!(producer_id: bobbee.id, invoice_number: "20161227", product_id: zukti_stout.id, mfgd_date: "2016-06-28", expiry_date: "2017-12-28", lot_name: "L1800616", mfgd_amount: 301)
