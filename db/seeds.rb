...
ProductionRun.create!(producer_id: bobbee.id, product_id: zukti_10oz.id, mfgd_date: "2015-11-20", lot_name: "L3241115", mfgd_amount: 805)
ProductionRun.create!(producer_id: bobbee.id, product_id: piaz_716oz.id, mfgd_date: "2015-11-20", lot_name: "L3241115", mfgd_amount: 131)
ProductionRun.create!(producer_id: bobbee.id, product_id: piaz_716oz.id, mfgd_date: "2015-12-03", lot_name: "L3371215", mfgd_amount: 130)
ProductionRun.create!(producer_id: bobbee.id, product_id: piaz_716oz.id, mfgd_date: "2016-01-12", lot_name: "L0120116", mfgd_amount: 97)
ProductionRun.create!(producer_id: bobbee.id, product_id: piaz_full.id, mfgd_date: "2016-01-12", lot_name: "L0120116", mfgd_amount: 3)
ProductionRun.create!(producer_id: bobbee.id, product_id: zukti_1166oz.id, mfgd_date: "2016-01-18", lot_name: "L_MISSING", mfgd_amount: 81)
ProductionRun.create!(producer_id: bobbee.id, product_id: zukti_stout.id, mfgd_date: "2016-01-18", lot_name: "L_MISSING", mfgd_amount: 12)
ProductionRun.create!(producer_id: bobbee.id, product_id: piaz_black_lid.id, mfgd_date: "2016-01-18", lot_name: "L_MISSING", mfgd_amount: 12)
ProductionRun.create!(producer_id: bobbee.id, product_id: zukti_1166oz.id, mfgd_date: "2016-02-17", lot_name: "L0180116", mfgd_amount: 32)
ProductionRun.create!(producer_id: bobbee.id, product_id: zukti_1166oz.id, mfgd_date: "2016-03-11", lot_name: "L07010316", mfgd_amount: 141)
ProductionRun.create!(producer_id: bobbee.id, product_id: zukti_full.id, mfgd_date: "2016-03-11", lot_name: "L07010316", mfgd_amount: 2)
ProductionRun.create!(producer_id: bobbee.id, product_id: zukti_1166oz.id, mfgd_date: "2016-03-11", lot_name: "L07010316", mfgd_amount: 168)
ProductionRun.create!(producer_id: bobbee.id, product_id: zukti_half.id, mfgd_date: "2016-03-28", lot_name: "L0880316", mfgd_amount: 6)
ProductionRun.create!(producer_id: bobbee.id, product_id: zukti_stout.id, mfgd_date: "2016-03-28", lot_name: "L0880316", mfgd_amount: 217)
ProductionRun.create!(producer_id: bobbee.id, product_id: piaz_black_lid.id, mfgd_date: "2016-03-30", lot_name: "L0890316", mfgd_amount: 379)
ProductionRun.create!(producer_id: bobbee.id, product_id: piaz_half.id, mfgd_date: "2016-03-30", lot_name: "L0890316", mfgd_amount: 6)
ProductionRun.create!(producer_id: bobbee.id, product_id: piaz_black_lid.id, mfgd_date: "2016-05-05", lot_name: "L1260516", mfgd_amount: 434)
ProductionRun.create!(producer_id: bobbee.id, product_id: zukti_stout.id, mfgd_date: "2016-05-05", lot_name: "L1260516", mfgd_amount: 954)
ProductionRun.create!(producer_id: bobbee.id, product_id: piaz_716oz.id, mfgd_date: "2016-06-01", lot_name: "L1520516", mfgd_amount: 210)
ProductionRun.create!(producer_id: bobbee.id, product_id: piaz_baby.id, mfgd_date: "2016-06-01", lot_name: "L1520516", mfgd_amount: 410)
ProductionRun.create!(producer_id: bobbee.id, product_id: zukti_plastic.id, mfgd_date: "2016-06-01", lot_name: "L1480516", mfgd_amount: 214)
ProductionRun.create!(producer_id: bobbee.id, product_id: zukti_stout.id, mfgd_date: "2016-06-28", lot_name: "L1800616", mfgd_amount: 301)
